...
d <- read.table("AitchisonTransformedDataForALDExInput.txt",sep="\t",header=TRUE,row.names=1)
...
write.table(y,file="ALDEx_output.txt",sep="\t",quote=FALSE)
